...
with engine.connect() as conn:
    try:
        ...
        gc = gspread.service_account(filename=r"D:\ProJ_Activity\Portfolio Project\Data Analyst_SQL-Snowflake-Python proj\Scripts\Python_scripts\service_account.json")
        
        loop_counter = 0
        chunk_size = 100
        file_name = 'OTODOM_ANALYSIS_'
        user_email = 'samarat13@gmail.com'
